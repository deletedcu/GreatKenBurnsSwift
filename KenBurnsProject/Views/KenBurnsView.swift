...
class KenBurnsView: UIView {
    ...
    var kenBurnsDelegate: KenBurnsViewDelegate?
    var isPaused: Bool {
        get {
    ...
    override func awakeFromNib() {
        ...
        if screenOrientationAwareness {
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(KenBurnsView.deviceOrientationDidChange), name: UIDevice.orientationDidChangeNotification, object: nil)
    ...
    func animateWithImagePaths(_ imagePaths: [String], imageAnimationDuration duration: TimeInterval, initialDelay delay: TimeInterval, shouldLoop loop: Bool, randomFirstImage randomize: Bool = randomFirstImage) {
        ...
        startAnimationsWith(duration, initialDelay: delay, shouldLoop: loop, randomFirstImage: randomize)
    }
    ...
    private func startAnimationsWith(_ duration: TimeInterval, initialDelay delay: TimeInterval, shouldLoop loop: Bool, randomFirstImage randomize: Bool) {
